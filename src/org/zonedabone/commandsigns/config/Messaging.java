...
public class Messaging extends ConfigStore {
  ...
  public String parseMessage(String message, String[] variables, String[] replacements) {
  ...
  public String parseRaw(String messageName, String[] variables, String[] replacements) {
  ...
  public void sendMessage(CommandSender cs, String messageName, String[] variables,
      String[] replacements) {
    if (cs != null) {
  ...
  public void sendRaw(CommandSender cs, String messageName, String[] variables,
      String[] replacements) {
    if (cs != null) {
