 ...
 * originator and recipient can be the same CommandSender Allows sendMessage() methods to be
 * intercepted if the silent flag is set
 */
public class CommandSenderProxy implements CommandSender {
  ...
  public CommandSenderProxy(CommandSender originator, CommandSender recipient, boolean silent) {
